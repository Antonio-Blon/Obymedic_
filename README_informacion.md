...
# 🏥 Sistema de Gestión de Historias Clínicas - OBYMEDIC

Sistema web para la gestión digital de registros médicos de Obstetricia y Medicina General.
...
- • Almacenar la información en una base de datos digital
...
Ejecutar GotagotaApplication.java
